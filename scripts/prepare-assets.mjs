...
const backgroundManifest = [{ id: 'paper-grain', path: '/brand/backgrounds/paper-grain.webp', type: 'raster-texture', repeatable: true, dimensions: '768x768' }];
await writeFile(at('public/brand/assets.json'), JSON.stringify({ poses: manifest, companion: companionManifest, stack: stackManifest, projectIcons: projectIconManifest, headerIcons: headerIconManifest, technologyIcons: technologyIconManifest, backgrounds: backgroundManifest, portrait: { webp: '/brand/roman.webp', svg: '/brand/roman.svg', type: 'embedded-raster' } }, null, 2));
console.log(JSON.stringify({ poses: manifest, companion: companionManifest, stack: stackManifest, projectIcons: projectIconManifest, headerIcons: headerIconManifest, technologyIcons: technologyIconManifest, backgrounds: backgroundManifest }, null, 2));
